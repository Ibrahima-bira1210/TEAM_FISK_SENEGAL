...
declare const _default: React.MemoExoticComponent<React.ForwardRefExoticComponent<import("../../primitives/Box").IBoxProps<ICircularProgressProps> & {
    ...
    value: number;
    size?: import("../../types").ResponsiveValue<number | "px" | "sm" | "md" | "lg" | "xl" | "full" | "6" | "2xs" | "8" | "xs" | "12" | "16" | "24" | "32" | "2" | "0.5" | "4" | "3" | "1" | "2xl" | "0" | "5" | "7" | "9" | "1.5" | "2.5" | "3.5" | "10" | "20" | "40" | "48" | "56" | "64" | "72" | "80" | "96" | "1/2" | "1/3" | "2/3" | "1/4" | "2/4" | "3/4" | "1/5" | "2/5" | "3/5" | "4/5" | "1/6" | "2/6" | "3/6" | "4/6" | "5/6" | "container" | "3xs" | (string & {})>;
