...
declare type AllProps<T extends StyledPropConfig> = {
    [key in Extract<keyof T, string>]?: T[key] extends boolean ? GetRNStyles<key> : key extends 'shadow' ? GetRNStyles<null, 'shadows'> : 'property' extends keyof T[key] ? GetRNStyles<T[key]['property'], T[key]['scale']> : 'properties' extends keyof T[key] ? T[key]['properties'] extends {
        '0': string;
